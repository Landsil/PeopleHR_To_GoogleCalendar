...
# print('Probably done')
pprint('list_of_people Probably done')
...
def remove_old_events():
    ...
    pprint('events_delete Probably done')
    # input('Press Enter to continue...')
...
def create_new_birthdays():
    ...
    pprint('people_with_missing_DateOfBirth Probably done')
    # print('Those have to be corrected')
    # input('Press Enter to continue...')

    # Debug
    # pprint(events_list)
    pprint('events_list Probably done')
...
def create_new_anniversaries():
    ...
    pprint('people_with_missing_StartDate Probably done')
    # print('Those have to be corrected')
    # input('Press Enter to continue...')
